...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://localhost/WP Final/Dashboard/dashboard/faculty1.php"><span>BMSCE</span>-ADMIN</a>
				<ul class="user-menu">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="http://localhost/WP Final/Dashboard/dashboard/faculty1.php"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
...
$result = mysqli_query($con,"SELECT * FROM register WHERE status=1 AND sem=1  ");
echo "<table border='10'>
<tr align='center'>
<th align='center'>USN</th>
<th align='center'>NAME</th>
<th align='center'>SEMESTER</th>
<th align='center'>SUBJECT-1</th>
<th align='center'>SUBJECT-2</th>
<th align='center'>SUBJECT-3</th>
<th align='center'>SUBJECT-4</th>
<th align='center'>SUBJECT-5</th>
<th align='center'>SUBJECT-6</th>
<th align='center'>SUBJECT-7</th>
<th align='center'>SUBJECT-8</th>
</tr>";
while($row = mysqli_fetch_array($result))
  {
  echo "<tr align='center' cellspacing='10'>";
  echo"<br />";
  echo "<td>" . $row['usn'] . "</td>";
   echo"<br />";
  echo "<td>" . $row['name'] . "</td>";
