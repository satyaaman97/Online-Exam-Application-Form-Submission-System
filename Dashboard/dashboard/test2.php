...
$result = mysqli_query($con,"SELECT * FROM register WHERE status=0 and sem=1 ");
echo "<table border='10' cellpadding='10' cellspacing='30'>
<tr align='center'>
...
while($row = mysqli_fetch_array($result))
  {
  echo "<tr>";
  echo "<td align='center' cellpadding='10'>" . $row['usn'] . "</td>";
