	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="http://localhost/WP Final/Dashboard/dashboard/test3.php"><span>BMSCE</span>-ADMIN</a>
				<ul class="user-menu">
...
$result = mysqli_query($con,"SELECT * FROM register WHERE status=1 and sem=2 ");
